...
import com.khaizro.blnotifly.MainActivity
import com.khaizro.blnotifly.NotificationService
import com.khaizro.blnotifly.domain.NotificationPayload

object NotificationHelper {

    private const val CHANNEL_ID = "notifly_channel_v1"
    private const val CHANNEL_NAME = "BLNotifly Notifications"
    ...
    fun toggleListenerService(context: Context) {
        ...
        Log.i("BLNotiflyNH", "NotificationService toggled to force re-bind")
    }

    @SuppressLint("MissingPermission")
    fun showLocalNotification(context: Context, payload: NotificationPayload) {
        Log.d("BLNotiflyNH", "showLocalNotification: ${payload.appName} - ${payload.title}")
    ...
    private fun buildNotification(context: Context, payload: NotificationPayload): NotificationCompat.Builder {
        ...
        return NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(com.khaizro.blnotifly.R.drawable.ic_notification)
            .setColor(ContextCompat.getColor(context, com.khaizro.blnotifly.R.color.md_theme_dark_primary))
