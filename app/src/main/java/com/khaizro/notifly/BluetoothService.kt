...
import com.khaizro.notifly.bluetooth.BluetoothConnectionManager
...
class BluetoothService : Service() {
    ...
    private val transferReceiver = object : BroadcastReceiver() {
        override fun onReceive(c: Context?, i: Intent?) {
            ...
            Log.d("NotiflyBS", "transferReceiver received data: $data")
            sendData(data)
        }
    }
    ...
    override fun onCreate() {
        ...
        recovery.register()
        val filter = IntentFilter("com.khaizro.notifly.TRANSFER")
    ...
    fun sendData(data: String) {
        Log.d("NotiflyBS", "Sending data to Bluetooth: $data")
    ...
    companion object {
        const val ACTION_STOP_SERVICE = "com.khaizro.notifly.STOP_SERVICE"
    }
}
